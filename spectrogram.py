...
#sample.plot_spectrogram(clim = [None, None])


########################### use plot method to view spectrogram ################################

#sample.plot_spectrogram(clim = [0.3, 1.5], timerange = '18:52:10.02~18:52:19.97', chanrange = '200~800')
#sample.plot_spectrogram(clim = [0.3, 1.5], timerange = '18:52:10.02~18:52:19.97', chanrange = '200~500')
#sample.plot_spectrogram(clim = [0.3, 1.5], timerange = '18:52:10.02~18:52:19.97', chanrange = '500~800')
